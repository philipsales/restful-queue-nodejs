...
//TODO: create API post for bulk appointments
router.post('/appointment/', (req, res) => {
    var message_id = req.params.pii_id;
    var pii_id = req.params.pii_id;

    console.log('POST GET');
    //TODO: do not reinitialize whole class, only use the function because will reinitialize
    //connections and cretae chanels every message request
    //initialize class 1x then use the function
    initAMQP.initAMQP(pii_id, message_id);
});
